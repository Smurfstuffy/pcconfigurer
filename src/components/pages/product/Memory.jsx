          ...
          <div className="card flex flex-col border-gray-500">
            <div className="flex flex-col h-full">
              ...
              <div className="flex pl-2 py-2">
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">Memory Speed:</p>
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">{data.speed.at(1)}</p>
              </div>
              <div className="flex pl-2 py-2">
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">Number of modules:</p>
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">{data.modules.at(0)}</p>
              </div>
              <div className="flex pl-2 py-2">
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">Capacity:</p>
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">{data.modules.at(1)}</p>
              </div>
              <div className="flex pl-2 py-2">
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">Latency:</p>
                <p className="basis-1/2 text-lg md:text-2xl font-semibold">{data.cas_latency}</p>
              </div>
              <div className="flex pl-2 py-2">
